...
CREATE TABLE call(
    ...
    FOREIGN KEY (customer_id) REFERENCES emplyee(id)
);

INSERT INTO emplyee(id, first_name, last_name)
...
SELECT emplyee.last_name, call.start_time, call.end_time
FROM emplyee, call
WHERE emplyee.id = call.employee_id;

SELECT customer.customer_name, customer.customer_addres, call.start_time, call.end_time
FROM customer, call
